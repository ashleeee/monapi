...
# this program is monachat application program interface ver 2.0 / create by ashlee
...
class monapi(object):
	""" comment : monachat application program interface ver 2.0 / create by ashlee"""
	def __init__(self) :
		self.room		=	  0
		self.name		=	  'Nameless'
		self.ihash		=	  'ihash'
	...
	def __extractid(self) :
		...
		iterator = re.finditer(pattern, self.response.decode('utf-8'))
